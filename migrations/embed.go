...
// service binary so the published image is self-sufficient: `api migrate up`
// needs no golang-migrate CLI, no separate migrate image, and no bind-mounted
// git checkout of this directory.
//
